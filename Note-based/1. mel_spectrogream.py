...
input_folder = "./data/musicnet/musicnet/test_data/"
output_folder = "./data"
...
# train_data 폴더에서 320개의 .wav 파일 전처리 (._ 파일 무시)
"""
맥북에서 ._* 파일 무시하기 위한 로직 추가
"""
audio_files = [
    f for f in os.listdir(input_folder) if f.endswith(".wav") and not f.startswith("._")
][:320]
